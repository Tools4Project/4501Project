...
# background = tk.Label(window, image = photo_image)
...
b_upload_art = tk.Button(window, text='Upload Art', font=('Times', 14,'bold'), width=20, height=3,command=hit_me1)
b_upload_art.place(x=60, y=500)

b_upload_pic = tk.Button(window, text='Upload Yor Picture', font=('Times', 14,'bold'), width=20, height=3,command=hit_me2)
b_upload_pic.place(x=330, y=500)

b_upload_pic = tk.Button(window, text='Process', font=('Times', 14,'bold'), width=20, height=3, command=cnn_paint_style)
b_upload_pic.place(x=580, y=500)
